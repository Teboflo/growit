...
const trabajos = [
    { id: 'webpage', titulo: 'Web', subtitle: 'Page', imagen: '../image/porta/sp-web.webp', categoria: { nombre: 'Web Design', id: 'web' }, link: 'https://summit-prime.netlify.app/', texto: 'Diseño web estructurado con enfoque en experiencia de usuario y jerarquía visual', cta: 'Visita el Sitio' },
    { id: 'webpage', titulo: 'Test', subtitle: 'Page', imagen: '../image/porta/web.webp', categoria: { nombre: 'Web Design', id: 'web' }, link: 'https://teboflo.github.io/one-connetion/', texto: 'Diseño Web de testeo, práctica de códificación y diseño landing page semi-profesional.', cta: 'Visita el Sitio' },
    ...
    { id: 'summit', titulo: 'SummitPrime', subtitle: 'Brand-kit', imagen: '../image/porta/sp-kit.webp', categoria: { nombre: 'Brand Kit', id: 'brand' }, link: 'https://www.instagram.com/summit.prime', texto: 'Rebranding, generación de marca con estilo minimalista moderno, enfocado en el acompañamiento y seguros.', cta: 'Ir a Perfil' },
